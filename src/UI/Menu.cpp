...
void Menu::onCredits()
{
	std::vector<std::vector<std::wstring>> credits = {
		...
		{L"Концепт-художник", L"Коломийцев Дмитрий"},
		...
		{L"Контент-менеджер", L"Коломийцев Дмитрий"},
		{L"Сценарист", L"Чубич Артем"},
		{L"Начальник отдела тестирования", L"Чубич Артем"},
		{L"Тестировщик", L"Коломийцев Дмитрий"},
		...
		{L"Аналитик", L"Коломийцев Дмитрий"},
		{L"Маркетолог", L"Коломийцев Дмитрий"},
